...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .servicio-title { font-family:'Cormorant Garamond',serif; font-size:2rem; font-weight:600; color:var(--navy); }
        ...
        /* ─── ASESORÍA ─── */
        #asesoria { background:var(--navy); padding:7rem 0; position:relative; overflow:hidden; }
        #asesoria::before {
            content: '✦';
            position: absolute;
            font-size: 20rem;
        ...
        .asesoria-card { background:rgba(10,26,69,.5); padding:2.2rem; transition:all .3s ease; }
        .asesoria-card:hover { background:rgba(201,168,76,.1); transform: translateY(-3px); }
        .asesoria-card-icon { font-size:1.5rem; color:var(--gold); margin-bottom:1rem; }
        ...
        /* Botones y estilos de navegación */
        ...
        .cta-box {
            background:var(--navy); border-radius:24px; padding:5rem;
        ...
        @media (max-width:900px) {
            ...
            .flip-card { width: 300px; height: 440px; }
            .counter-grid { gap: 1rem; }
            .counter-item { padding: 1rem; min-width: 130px; }
        }
    ...
    <main>
        ...
        <section class="benefits-section" data-aos="fade-up">
            <div class="section-wrap">
                ...
                <!-- Contadores animados (elemento atractivo extra) -->
                    ...
                    <div class="flip-card" data-aos="flip-left" data-aos-delay="100">
                        <div class="flip-inner">
                            <div class="flip-front">
                                ...
                                <h3 style="font-size: 1.9rem; font-weight: 600;">Económicos</h3>
                                <p style="color:#4b5563; margin-top: 0.5rem;">Mayor rentabilidad garantizada</p>
                                <div style="margin-top: 1rem;"><i class="fas fa-arrow-right" style="color:#c9a84c;"></i> <span style="font-size:0.75rem;">pasa el mouse</span></div>
                            </div>
                            <div class="flip-back">
                                <i class="fas fa-coins" style="font-size: 2rem; color:#c9a84c;"></i>
                                <ul>
                                ...
                                <div style="margin-top: auto; background: rgba(255,255,255,0.08); border-radius: 30px; padding: 0.7rem; text-align: center;">
                                    <strong style="color:#e4c97e;">⬆ mayor rentabilidad del inmueble</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flip-card" data-aos="flip-left" data-aos-delay="200">
                        <div class="flip-inner">
                            <div class="flip-front">
                                ...
                                <h3 style="font-size: 1.9rem; font-weight: 600;">No Económicos</h3>
                                <p style="color:#4b5563; margin-top: 0.5rem;">Tranquilidad + resguardo total</p>
                                <div style="margin-top: 1rem;"><i class="fas fa-magic"></i> <span style="font-size:0.75rem;">descubre la magia</span></div>
                            </div>
                            <div class="flip-back">
                                <i class="fas fa-shield-heart" style="font-size: 2rem; color:#c9a84c;"></i>
                                <ul>
                                    <li><i class="fas fa-check-circle"></i> Seguridad con respaldo profesional, supervisión a múltiples niveles</li>
                                    ...
                                    <li><i class="fas fa-check-circle"></i> Gestión total en ausencia geográfica: tu inmueble bien cuidado y altamente rentable</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carrusel-wrapper" data-aos="fade-up">
                    <div style="text-align: center; margin-bottom: 2rem;">
                        ...
                        <h3 style="font-size: 1.7rem; font-family: 'Cormorant Garamond', serif;">Más que gestión: <em>experiencia premium</em></h3>
                    </div>
                ...
                <div class="result-gold-banner" data-aos="zoom-in">
                    <div>
                        ...
                        <p style="color: rgba(255,255,255,0.8); margin-top: 0.5rem;">Optimización del alquiler, reducción de vacancias, inquilinos evaluados y respaldo continuo.</p>
                    </div>
